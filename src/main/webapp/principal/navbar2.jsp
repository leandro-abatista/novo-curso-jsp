	...
	<div class="pcoded-inner-navbar main-menu">
		<div class="">
			...
			<c:if test="${imagemUsuario != ' ' && imagemUsuario != null}">
				<img class="img-80" src="${imagemUsuario}" alt="User-Profile-Image">
			</c:if>	
			
			<c:if test="${imagemUsuario == ' ' || imagemUsuario == null}">
				<img class="img-80 img-radius" src="<%= request.getContextPath() %>/assets/images/sem-imagem2.png" alt="User-Profile-Image">
			</c:if>
				
				<div class="user-details">
					<span id="more-details"><%= session.getAttribute("usuarioLogado") %>
		...
		<ul class="pcoded-item pcoded-left-item">
			...
			<li class="pcoded-hasmenu">
				...
				<a href="javascript:void(0)" class="waves-effect waves-dark"> 
					...
					<span style="font-size: 16px; font-weight: bold;" class="pcoded-mtext" data-i18n="nav.basic-components.main">Cadastros</span>
				    <span class="pcoded-mcaret"></span>
				</a>
					...
					<c:if test="${perfil == 'ADMINISTRADOR'}">
						<li class=" ">
							<a href="<%=request.getContextPath()%>/ServletUsuarioController?acao=listarUsuarios" class="waves-effect waves-dark"> 
								...
								<span style="font-size: 15px; font-weight: bold;" class="pcoded-mtext" data-i18n="nav.basic-components.alert">Cad. Usuário</span> 
								<span class="pcoded-mcaret"></span>
							</a>
						</li>
					</c:if>
					...
					<!-- submenu de cadastro de produto -->
						<li class=" ">
							<a href="<%=request.getContextPath()%>/principal/cad_produto.jsp" class="waves-effect waves-dark"> 
								...
								<span style="font-size: 15px; font-weight: bold;" class="pcoded-mtext" data-i18n="nav.basic-components.alert">Cad. Produto</span> 
								<span class="pcoded-mcaret"></span>
							</a>
						</li>
				</ul>
			...
			<div class="pcoded-navigation-label" data-i18n="nav.category.forms" style="font-size: 16px">Relatório</div>
			...
			<ul class="pcoded-item pcoded-left-item">
				<li>
					<a href="<%=request.getContextPath()%>/principal/relatorioUsuario.jsp" class="waves-effect waves-dark"> 
						...
						<span style="font-size: 15px; font-weight: bold;" class="pcoded-mtext" data-i18n="nav.form-components.main">Usuário</span> 
						<span class="pcoded-mcaret"></span>
					</a>
				</li>
				<li>
					<a href="bs-basic-table.html" class="waves-effect waves-dark"> 
						...
						<span style="font-size: 15px; font-weight: bold;" class="pcoded-mtext" data-i18n="nav.form-components.main">Produto</span> 
						<span class="pcoded-mcaret"></span>
					</a>
				</li>
			</ul>
